...
- Para variáveis de texto (`chr`), como `Author`, exibe apenas o número de valores (`Length`) e o tipo da variável (`Class` e `Mode`). A frequência de cada categoria só é exibida quando a variável é um fator (`factor`).
