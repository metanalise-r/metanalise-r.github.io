...
![Painel *Environment* do RStudio após a criação do objeto `m.acm`.](imagens/cap06-environment-rstudio.png){width="70%"}
...
ma$acm[3:7, "Year"]      # Seleciona as linhas 3 a 7 da coluna "Year"
```
